...
## [v7.00] — 2026-05-02
### Giga-Intel Genius Mode & Surgical Profiling
- **Surgical Discovery**: Sistem kini mendeteksi lokasi link (Header/Footer/Nav) dan memprioritaskannya untuk akurasi profilasi yang lebih tinggi.
- **Zero-Hallucination Prompt**: Memperbarui instruksi AI untuk melarang pengambilan angka dari URL/Tanggal sebagai nomor telepon. Field dikosongkan jika data tidak ditemukan.
- **Fax & Ads Filtering**: Menambahkan filter otomatis untuk membuang nomor Fax/Faks dan memprioritaskan nomor Redaksi.
- **Clean Notifications**: Menghapus label ber-kurung siku ([nama laman], dsb) untuk output yang lebih bersih dan profesional.
- **Smart Skip**: Menghindari 'bruteforce' URL jika link berkualitas sudah ditemukan di struktur halaman utama.
